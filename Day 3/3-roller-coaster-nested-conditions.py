...
# use of float to accomodate both whole numbers and whole numbers with decimal points
...
if height >= 120:  # height greater or equal to 120
    ...
    # converts input to capital letter before its checked because the function only accepts capital letter
...
# Test it here: https://replit.com/@terrykirungo/3-roller-coaster-nested-conditions#main.py
