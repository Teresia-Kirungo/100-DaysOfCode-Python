# Data Types
# Subcripting, pulling out the first index of a string, e.g in print("Hello[0]") will print out the first letter in Hello which is H, the character in the index 0 
